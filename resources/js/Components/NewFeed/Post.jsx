...
const Post = (props) => {
    ...
    return (
        <div
            ...
            className=' p-[27px] md:p-[35px] w-full md:w-[550px]  bg-white border rounded-lg '>
            <div className="flex items-center justify-between mb-3 post-header">
                <div className="flex items-center gap-3 ">
                    ...
                    <div className="">
                        <Link href={route('account.view', singlePost.account.id)} className=' text-[14px] md:text-[16px] font-semibold flex items-center gap-1 '>
                        ...
                        <p className=' text-[12px] md:text-[14px] flex items-center gap-1 text-main-bright font-semibold'>
                            {/* <TbZodiacTaurus /> */}
            ...
            <div className="post-content mt-[20px]">
                {
                    ...
                    <div className="flex w-full gap-1 mb-3 ">
                        {
                            route().current('home') ? singlePost.images.map((img, index) => <Link href={route('post.show', singlePost.id)} key={`${singlePost.id}-${index}`} className="w-full h-[180px]  md:h-[250px]">
